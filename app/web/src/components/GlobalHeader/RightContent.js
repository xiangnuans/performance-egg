...
export default class GlobalHeaderRight extends PureComponent {
  ...
  ChangeNoticeStatus = (id, status) => {
    ...
    const { userId, roomId, groupId } = currentUser;
    dispatch({
      type: 'global/updateNotice',
      payload: {
        status,
        id,
        userId,
  ...
  handleAccept = clickedItem => {
    this.ChangeNoticeStatus(clickedItem.id, 1);
  };

  handleReject = clickedItem => {
    this.ChangeNoticeStatus(clickedItem.id, 2);
  };
